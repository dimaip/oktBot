...
def sendMedia(message):
    mesg = bot.send_message(
        message.chat.id, 'Загрузите фото и видео с чтения имён в вашем городе. Чтобы все фото дошли до нас, пожалуйста, НЕ ГРУППИРУЙТЕ их.', reply_markup=backButtonMarkup)
